...
- [构图产品调研](product/COMPOSITION_MARKET.md)：2026-09-08 调研材料，非实时功能排名。
...
- [Android AI 调色实现](architecture/AI_COLOR.md)：当前状态与历史增补分开阅读。
...
- [Checklist 导航](testing/CHECKLIST.md)：旧清单的导读，分别指向当前验收与历史快照。
...
- [应用图标制作说明](reference/APP_ICON.md)：Android 图标资源与生成记录。

## 历史记录：history

历史文件保留原日期与结果，仅修正链接；当前发布状态应查看 `testing/`。

- [Android 相机与调色复核 · 2026-09-08](history/REVIEW_20260908.md)。
- [Android 历史 Checklist · 2026-09-08](history/ANDROID_CHECKLIST_20260908.md)。

## 平台差异

本分支保留 Android AI 调色说明、图标制作、产品调研与 Android 历史记录；iOS 专属调色说明和界面 review 见 `ios` 分支对应目录。不能用 iOS 截图代替 Android 验收。
